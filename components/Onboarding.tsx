...
const slides = [
    {
        ...
        desc_en: 'The most advanced sports prediction platform in Africa. Powered by Google Gemini AI — live data, real analysis, real results.',
        desc_fr: 'La plateforme de pronostics sportifs la plus avancée d\'Afrique. Propulsée par Google Gemini AI — données en direct, vraie analyse.',
    },
    {
        id: 'ai',
        icon: Bot,
