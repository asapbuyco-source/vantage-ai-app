          ...
          <div className="fixed inset-0 z-[70] flex items-center justify-center p-4 pointer-events-none">
            {
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex justify-center items-center space-x-4 opacity-50 grayscale">
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/MTN_Logo.svg/1024px-MTN_Logo.svg.png" alt="MTN" className="h-6" />
                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Orange_logo.svg/1200px-Orange_logo.svg.png" alt="Orange" className="h-6" />
                    </div>
                </div>
                </motion.div>
            }
